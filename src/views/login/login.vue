<template>
  <div class="login">
    ...
    <a-form @submit.prevent="doLogin" :form="form">
          ...
          <a-form-item>
            <a-row :gutter="8" style="margin:0 -4px">
              ...
              <a-col :span="8" style="padding-left:4px">
                <a-buton style="width:100%" class="captcha-button" size="large" @click="getCaptcha">获取验证码</a-buton>
              </a-col>
            </a-row>
          </a-form-item>
        </a-tab-pane>
      ...
      <a-form-item>
        <a-button :loading="loading" style="width:100%;margin-top:4px;" size="large" htmlType="submit" type="primary">登录</a-button>
      </a-form-item>
      <div>
